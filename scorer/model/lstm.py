...
class SiameneLSTM:
    ...
    def train_model(self, sentences_pair, feat, scores, embedding_meta_data, model_save_directory='./'):
        ...
        sequence_2_input = Input(
            shape=(self.max_sequence_length,), dtype='int32')  # Input 1
        ...
        sequence_1_input = Input(
            shape=(self.max_sequence_length,), dtype='int32')  # Input 2
        embedded_sequences_1 = embedding_layer(sequence_1_input)
        x1 = keras.layers.Subtract()(
            [embedded_sequences_1, embedded_sequences_2])  # dist = v1 - v2
        x1 = lstm_layer1(x1)
        x1 = Dropout(0.4)(x1)
        ...
        leaks_dense_layer = Dense(
            self.number_dense_units, activation=self.activation_function)
